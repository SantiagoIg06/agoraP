...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/agoraP-main/USUARIO/buscarEmp.css">
...
<body>
    ...
    <ul id="work-list">
      <a href="http://localhost/agoraP-main/USUARIO/infEmp.php" style="text-decoration: none; color: black;">
        <li>
          <div class="work-info">
          ...
          <a href="http://localhost/agoraP-main/USUARIO/contact.php"><button class="chat-button">Contactanos</button></a>
        </li>
      </a>
      <a href="http://localhost/agoraP-main/USUARIO/infEmp.php" style="text-decoration: none; color: black;">
        <li>
    ...
    <ul id="work-list">
      ...
      <a href="/USUARIO/infEmp.html" style="text-decoration: none; color: black;">
        <li>
          <div class="work-info">
              <img class="imgEmp" src="http://localhost/agoraP-main/imagenes/usadas/Trabajos.jpg" alt="Empresas">
            <h3>Empresa XYZ</h3>
