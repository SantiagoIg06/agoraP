        ...
        if ($resultado->num_rows > 0) {
            ...
            switch ($idRol) {
                case 1:
                    ...
                    header("Location: http://localhost/agoraP-main/USUARIO/usuarioInf.php");
                    break;
                case 2:
                    // Redireccionar si el rol es Empresa
                    header("Location: http://localhost/agoraP-main/EMPRESA/perfilEmpresa.php");
                    break;
                case 3:
                    // Redireccionar si el rol es Admin
                    header("Location: http://localhost/agoraP-main/admin/pPrincipal.php");
                    break;
                default:
