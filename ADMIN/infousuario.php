    ...
    <section>
        ...
        <div id="lat_der">
            ...
            <div class="textos">
                <img src="http://localhost/agoraP-main/imagenes/logosSimbolos/perfil.png" alt="">
                <h3>Usuario<br>
                    Soy una persona la cual esta dispuesta a trabajar con la empresa la cual me de la oportunidad
                    de trabajar con ellos si estan interesados en mi tienen mis numero moviles en esta informacion
                    para que asi puedan hablar directamente conmigo
        </div>
        <div class="bre">
            <a href="http://localhost/agoraP-main/adregistro.PHP"><button>Ir al menu anterior</button></a>
        </div>
    </section>
