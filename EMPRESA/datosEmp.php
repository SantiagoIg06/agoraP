...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/agoraP-main/EMPRESA/estilosemp/datosEmp.css">
                ...
                <div class="contP card-body p-5 text-center">
                  ...
                  <div class="mb-md-5 mt-md-4 pb-5">
                    ...
                    <form>
                        ...
                        <!-- Submit button -->
                        <a href="http://localhost/agoraP-main/EMPRESA/perfilEmpresa.php"><button data-mdb-ripple-init type="button" class="btn btn-primary btn-block mb-4">Siguiente</button></a>
